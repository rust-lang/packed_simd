...
// impl_fsin!(f32x2: sin_v2f32); // FIXME: 64-bit wide vectors
impl_fsin!(f32x4: sin_v4f32);
impl_fsin!(f32x8: sin_v8f32);
// impl_fsin!(f32x16: sin_v16f32); // FIXME: 512-bit wide vectors
impl_fsin!(f64x2: sin_v2f64);
impl_fsin!(f64x4: sin_v4f64);
// impl_fsin!(f64x8: sin_v8f64); // FIXME: 512-bit wide vectors
