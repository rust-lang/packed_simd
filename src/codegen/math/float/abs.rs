...
// impl_fabs!(f32x2: abs_v2f32); // FIXME: 64-bit wide vectors
impl_fabs!(f32x4: abs_v4f32);
impl_fabs!(f32x8: abs_v8f32);
// impl_fabs!(f32x16: abs_v16f32); // FIXME: 512-bit wide vectors
impl_fabs!(f64x2: abs_v2f64);
impl_fabs!(f64x4: abs_v4f64);
// impl_fabs!(f64x8: abs_v8f64); // FIXME: 512-bit wide vectors
