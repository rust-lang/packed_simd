...
// impl_fma!(f32x2: fma_v2f32); // FIXME: 64-bit wide vectors
impl_fma!(f32x4: fma_v4f32);
impl_fma!(f32x8: fma_v8f32);
// impl_fma!(f32x16: fma_v16f32); // FIXME: 512-bit wide vectors
impl_fma!(f64x2: fma_v2f64);
impl_fma!(f64x4: fma_v4f64);
// impl_fma!(f64x8: fma_v8f64); // FIXME: 512-bit wide vectors
