...
// impl_fcos!(f32x2: cos_v2f32); // FIXME: 64-bit wide vectors
impl_fcos!(f32x4: cos_v4f32);
impl_fcos!(f32x8: cos_v8f32);
// impl_fcos!(f32x16: cos_v16f32); // FIXME: 512-bit wide vectors
impl_fcos!(f64x2: cos_v2f64);
impl_fcos!(f64x4: cos_v4f64);
// impl_fcos!(f64x8: cos_v8f64); // FIXME: 512-bit wide vectors
