...
impl_u!([u128; 1]: u128x1, m128x1 | x0 |
        From: /*u8x1, u16x1, u32x1, u64x1*/ |
        /// A 128-bit vector with 1 `u128` lane.
);
impl_m!([m128; 1]: m128x1 | i128 | x0 | From: /*m64x1*/ |
